...
class Googlemaps {
	...
	function get_lat_long_from_address($address, $attempts = 0)
	{
		...
		$data_location .= "maps.google.com/maps/api/geocode/json?key=AIzaSyA77jUPPqj03Clf5H5UJ8ltE3CwdblMwMs&address=".urlencode(utf8_encode($address))."&sensor=".$this->sensor;
